class Cart{
  ...
  cartItems; //public property - accessed anywhere
  #localStorageKey ; //private property - accessed inside the class, (inside the curly brackets)
  ...
  #loadFromStorage(){ //private methods
